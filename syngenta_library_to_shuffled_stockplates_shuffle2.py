...
Times 4 (3 plates are full and last plate only has top 4 rows):
...
tiprackdrugs_type = 'opentrons-tiprack-300ul'
...
drugs_mapping = {}
seed = 202001242 # for reproducibility. Let's use the experimental date for the actual experiment and the run number, something else for debugging
np.random.seed(seed)
