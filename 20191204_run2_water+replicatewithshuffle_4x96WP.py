...
# destination plates
agar_thickness = +3.6 # mm from the bottom of the well
destination_slots = ['2','5','8','11']
...
drugs_mapping = {}
seed = 20191204 # for reproducibility. Let's use the experimental date for the actual experiment, something else for debugging
np.random.seed(seed)
