...
- Tip rack for multi-channel pipette: 2
...
# Pipette params
multi_pipette_type = 'p50-Multi'  # Type of multi pipette used
...
# LF: the start_from is "from which well/column to start".
# The robot will already start from slot 7 on the deck as that was your first
# entry in the list. See line 108

# Air gap params
aspirating_volume = 10            # Bacterial volume to pick up
dispensing_volume = 15            # Bacterial volume to dispense (greater to ensure all contents are dispensed)
...
# Dunno if it may have bad effects like the droplet of bacteria not detaching
